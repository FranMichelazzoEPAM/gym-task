1. Implement three gym.service classes Trainee Service, Trainer Service, Training Service
...
1. Configure spring application context based on the Spring annotation or on Java based
   approach.
2. Implement DAO objects for each of the gym.domain model entities (Trainer, Trainee,
...
4. DAO with storage bean should be inserted into services beans using auto wiring. Services
   beans should be injected into the gym.facade using constructor-based injections. The rest of
